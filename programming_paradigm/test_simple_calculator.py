...
class TestSimpleCalculator (unittest.TestCase):
  ...
  def test_addition(self):
    ...
    self.assertEqual(self.my_test_cal,result,23)

  def test_sub(self):
    result = self.my_test_cal.subtract(10,5)
    self.assertEqual(self.my_test_cal,result,5)

  def test_mult(self):
    result = self.my_test_cal.multiply(10,5)
    self.assertEqual(self.my_test_cal,result,50)

  def test_div(self):
    result = self.my_test_cal.divide(10,5)
    self.assertEqual(self.my_test_cal,result,2)
